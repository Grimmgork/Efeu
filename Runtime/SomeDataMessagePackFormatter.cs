...
namespace Efeu.Runtime
{
    public class SomeDataMessagePackFormatter : IMessagePackFormatter<SomeData>
    {
        ...
        public SomeDataMessagePackFormatter(Dictionary<int, object>? references)
        {
            this.references = references ?? new Dictionary<int, object>();
        }

        public SomeDataMessagePackFormatter()
        {
            this.references = new Dictionary<int, object>();
        }
