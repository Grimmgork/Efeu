...
namespace Efeu.Integration.Sqlite.Migrations
{
    public class _0001_Initial : IEfeuMigration
    {
        ...
        public async Task Up()
        {
            ...
            await connection.ExecuteAsync("CREATE TABLE Trigger (Id TEXT PRIMARY KEY, BehaviourVersionId INTEGER, CorrelationId TEXT, CreationTime INTEGER, Input TEXT, Position TEXT, ScopeId TEXT, [Group] TEXT, Type TEXT, Tag TEXT, Matter TEXT, IsDetatched INTEGER, FOREIGN KEY(BehaviourVersionId) REFERENCES BehaviourVersion(Id))");
