...
public class _0001_Initial : IEfeuMigration
{
    ...
    public async Task Up()
    {
        ...
        await connection.ExecuteAsync("CREATE TABLE BehaviourVersion (Id TEXT PRIMARY KEY, BehaviourId INTEGER, Version INTEGER, Steps TEXT, FOREIGN KEY(BehaviourId) REFERENCES Behaviour(Id))");
        await connection.ExecuteAsync("CREATE TABLE Trigger (Id TEXT PRIMARY KEY, BehaviourVersionId TEXT, CorrelationId TEXT, CreationTime INTEGER, Input TEXT, Position TEXT, ScopeId TEXT, LoopbackScopeId TEXT, [Group] TEXT, Type TEXT, Tag TEXT, Matter TEXT, IsDetatched INTEGER, FOREIGN KEY(BehaviourVersionId) REFERENCES BehaviourVersion(Id))");
