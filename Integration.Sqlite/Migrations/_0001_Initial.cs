...
namespace Efeu.Integration.Sqlite.Migrations
{
    public class _0001_Initial : IEfeuMigration
    {
        ...
        public async Task Up()
        {
            ...
            await connection.ExecuteAsync("CREATE TABLE Trigger (Id TEXT PRIMARY KEY, DefinitionVersionId INTEGER, CorrelationId TEXT, CreationTime INTEGER, Input TEXT, Position TEXT, Scope TEXT, Name TEXT, Tag TEXT, EffectId INTEGER, FOREIGN KEY(DefinitionVersionId) REFERENCES DefinitionVersion(Id))");
